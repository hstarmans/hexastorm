...
def cross_scan_error(
    img, pixelsize=3, debug=False, fname="crossscanndebug.jpg"
):
    ...
    extracted = cv.bitwise_and(
        thresh,
        (cv.drawContours(bw, [c], contourIdx=0, color=1, thickness=cv.FILLED)),
    )
    # skeletonize
